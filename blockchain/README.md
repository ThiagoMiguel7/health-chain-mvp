...
```sh
./target/release/healthchain-node -h
```
...
```sh
RUST_BACKTRACE=1 ./target/release/healthchain-node -ldebug --dev
```
...
$ ./target/release/healthchain-node --dev --base-path ./my-chain-state/
